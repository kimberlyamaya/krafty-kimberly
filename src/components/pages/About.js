    ...
    return (
        <div className='container'>
            ...
            <div className='d-flex bio'>
                ...
                <p>I have a background in warehousing, IT systems support for a third party distribution center, including writing intricate SQLs for an oracle database, training users on new systems and procedures, and implementing new systems and procedures. I am self-motivated, detailed orientated, and work great on my own and in a group setting. I am a fast learner and am fascinated with coding and web development. I am working towards receiving a certificate to become a full stack web developer. Check out my portfolio of deployed applications!</p>
            </div>
        </div>
    )
}
